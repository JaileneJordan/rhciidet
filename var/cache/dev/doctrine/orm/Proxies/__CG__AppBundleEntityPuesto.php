 ...
 */
class Puesto extends \AppBundle\Entity\Puesto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Puesto' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Puesto' . "\0" . 'descripcion', '' . "\0" . 'AppBundle\\Entity\\Puesto' . "\0" . 'activo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Puesto $proxy) {
